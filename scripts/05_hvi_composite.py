...
def main() -> int:
    ...
    if not sens_csv.exists():
        print(f"ERROR: Missing {sens_csv}. Run 02_census_sensitivity.py after 03_adaptive_capacity.py.")
        return 1
    if not expo_csv.exists():
        print(f"ERROR: Missing {expo_csv}. Run 04_exposure_lst.py after 03_adaptive_capacity.py.")
        return 1
